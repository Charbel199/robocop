...
class RawData(_object):
    ...
    __swig_setmethods__["pseudoData"] = _roypy.RawData_pseudoData_set
    __swig_getmethods__["pseudoData"] = _roypy.RawData_pseudoData_get
    if _newclass:
        pseudoData = _swig_property(_roypy.RawData_pseudoData_get, _roypy.RawData_pseudoData_set)
...
class DepthData(_object):
    ...
    __swig_setmethods__["illuminationTemperature"] = _roypy.DepthData_illuminationTemperature_set
    __swig_getmethods__["illuminationTemperature"] = _roypy.DepthData_illuminationTemperature_get
    if _newclass:
        illuminationTemperature = _swig_property(_roypy.DepthData_illuminationTemperature_get, _roypy.DepthData_illuminationTemperature_set)
...
_roypy.ProcessingFlag_AmplitudeThreshold_Float_swigconstant(_roypy)
ProcessingFlag_AmplitudeThreshold_Float = _roypy.ProcessingFlag_AmplitudeThreshold_Float

_roypy.ProcessingFlag_UseDotReProject_Bool_swigconstant(_roypy)
ProcessingFlag_UseDotReProject_Bool = _roypy.ProcessingFlag_UseDotReProject_Bool

_roypy.ProcessingFlag_UseMinimalPipeline_Bool_swigconstant(_roypy)
ProcessingFlag_UseMinimalPipeline_Bool = _roypy.ProcessingFlag_UseMinimalPipeline_Bool

_roypy.ProcessingFlag_SpotSearchMinSnr_Float_swigconstant(_roypy)
